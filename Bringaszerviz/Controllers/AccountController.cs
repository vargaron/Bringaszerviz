...
namespace Bringaszerviz.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            {
                if ((Roles.GetRolesForUser(model.UserName))[0].Equals("Service"))
        ...
        public ActionResult DisplayHome(LoginModel model)
        {
            if (Roles.IsUserInRole("Service"))
                return RedirectToAction("ListAll", "Tickets");
            else return RedirectToAction("Index", "Tickets");
        }
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                using (BikeServiceContext db = new BikeServiceContext())
                {
